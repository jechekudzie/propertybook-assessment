...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">Add New Feature</h1>
        ...
        <div class="card-body">
            <form action="{{ route('admin.features.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('tab_name') is-invalid @enderror" id="tab_name" name="tab_name" value="{{ old('tab_name') }}" required>
                    @error('tab_name')
                ...
                <div class="mb-3">
                    ...
                    @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div class="form-text">Recommended size: 540px × 360px</div>
                </div>
